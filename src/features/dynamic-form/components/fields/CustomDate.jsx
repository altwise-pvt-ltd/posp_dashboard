const CONTROL =
  'w-full rounded-xl border bg-slate-50 px-3 py-2 text-[0.8125rem] text-slate-900 transition-all duration-200 hover:bg-slate-100/50 focus:bg-white focus:border-orange-500 focus:outline-none focus:ring-4 focus:ring-orange-500/20 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 sm:px-3.5 sm:py-2.5 sm:text-sm';

function CustomDate({ field, value, error, disabled, onChange, onBlur }) {
  const { code, label, required, helperText } = field;
