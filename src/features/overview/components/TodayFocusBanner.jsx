...
function TodayFocusBanner({
  ...
  return (
    <section className="rounded-xl p-4 sm:p-gutter flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 sm:gap-gutter relative overflow-hidden bg-gradient-to-r from-primary-fixed to-primary-fixed/40 border border-gray-200 anim-fade-d2">
      <div className="absolute -right-10 -bottom-10 w-40 h-40 rounded-full bg-primary-container/10 pointer-events-none" />

      <div className="flex items-start xl:items-center gap-4 sm:gap-gutter relative z-10">
      ...
      <AppLink
        to={to}
        className="bg-primary-container px-gutter py-unit rounded font-body-lg text-body-lg flex items-center gap-unit shrink-0 hover:bg-primary-container/90 transition-all hover:gap-3 relative z-10 w-full xl:w-auto justify-center font-semibold text-white shadow-[0_4px_12px_-4px_rgba(255,107,0,.4)]"
      >
