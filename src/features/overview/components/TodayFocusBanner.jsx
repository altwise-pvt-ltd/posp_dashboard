...
function TodayFocusBanner({
  ...
  return (
    <section className="rounded-xl p-4 sm:p-gutter flex flex-col md:flex-row items-start md:items-center justify-between gap-4 sm:gap-gutter relative overflow-hidden bg-gradient-to-r from-primary-fixed to-primary-fixed/40 border border-gray-200 anim-fade-d2">
      <div className="absolute -right-10 -bottom-10 w-40 h-40 rounded-full bg-primary-container/10 pointer-events-none" />

      <div className="flex items-start md:items-center gap-4 sm:gap-gutter relative z-10">
