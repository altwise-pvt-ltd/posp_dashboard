...
const ShapeGrid = ({
    ...
    shape = 'square',
    hoverTrailAmount = 0,
    backgroundMode = 'dark' // 'dark', 'light', or 'transparent'
}) => {
        ...
        const drawGrid = () => {
            ...
            if (backgroundMode !== 'transparent') {
                ...
                if (backgroundMode === 'light') {
                    ...
                    gradient.addColorStop(1, '#f3f4f6'); // tailwind gray-100
                } else {
    ...
    }, [direction, speed, borderColor, hoverFillColor, squareSize, shape, hoverTrailAmount, backgroundMode]);
